...
const getMapHtmlContent = (map, callback) => {
    ...
    return `<button class="map-btn" onclick="${callback}">
...
const SelectMap = (map) => {
    ...
    mapLocations.forEach(boxLocation => {
        let button = `<button class="map-btn" id="${boxLocation}" onclick="AddToCycle('${boxLocation}', false)" oncontextmenu="AddToCycle('${boxLocation}', true); return false;">
